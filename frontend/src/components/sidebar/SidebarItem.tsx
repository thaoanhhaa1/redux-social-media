        ...
        <NavLink
            ...
            className={({ isActive }) =>
                classNames(
                    ...
                    'flex gap-4 p-4 rounded-2.5 hover:text-blue-white-2 dark:hover:text-blue-white-2 hover:fill-blue-white-2 dark:hover:fill-blue-white-2 transition-color-fill',
                )
            }
        >
